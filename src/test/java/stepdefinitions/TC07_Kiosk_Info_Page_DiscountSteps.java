...
/**
 * Migrated from tests.TC07_Kiosk_Info_Page_Discount — full Selenium logic lives here (no delegation).
 */
public class TC07_Kiosk_Info_Page_DiscountSteps extends BaseTest_Operator {
    private static final Logger log = LogManager.getLogger(TC07_Kiosk_Info_Page_DiscountSteps.class);
